...
namespace Sidebar
{
    ...
    /*
        ...
        * controls documentation are contained in three DLLs: Comctl32.dll, Shell32.dll, and Shlwapi.dll. 
        * Because of ongoing enhancements, different versions of these DLLs implement different features. 
        * Throughout this document, programming elements are marked with a version number. 
        * This version number indicates that the programming element was first implemented in that version and will 
        * also be found in all subsequent versions of the DLL. If no version number is specified, the programming element 
        * is implemented in all versions. The following table outlines the different DLL versions, and how they were distributed.
        * 
        ...
        *
        * Note 1: 
        * The 4.00 versions of Shell32.dll and Comctl32.dll are found on the original versions of Windows 95 and Windows NT 4.
        * New versions of Commctl.dll were shipped with all Internet Explorer releases. 
        * Shlwapi.dll first shipped with Internet Explorer 4.0, so its first version number is 4.71. 
        ...
        * they were not necessarily installed (see note 2). For subsequent releases, the version numbers 
        ...
        *
        * Note 2:
        * All systems with Internet Explorer 4.0 or 4.01 will have the associated version of Comctl32.dll and 
        * Shlwapi.dll (4.71 or 4.72, respectively). However, for systems prior to Windows 98, Internet Explorer 4.0 and 4.01
        * can be installed with or without the integrated Shell. If they are installed with the integrated Shell, 
        * the associated version of Shell32.dll will be installed. If they are installed without the integrated Shell, Shell32.dll
        * is not updated. In other words, the presence of version 4.71 or 4.72 of Comctl32.dll or Shlwapi.dll on a system
        * does not guarantee that Shell32.dll has the same version number. All Windows 98 systems have version 4.72 of Shell32.dll.
        * 
        * Note 3:
        ...
        * Windows 95, or Windows 98 systems. Version 5.0 of Shell32.dll will be distributed with Windows 2000 and Windows Me,
        * along with version 5.0 of Shlwapi.dll, and version 5.81 of Comctl32.dll.
        * 
        * Note 4:
        * ComCtl32.dll version 6 is not redistributable. If you want your application to use ComCtl32.dll version 6,
        ...
        * ========================================================================================
        * 
        * Applications frequently use a number of folders which might not have the same name or location on any given system. 
        * For example, the system folder might be called C:\Windows on one system and C:\Winnt on another. 
        * CSIDL values provide a unique system-independent way to identify these special folders. 
        * The values supersede the use of environment variables for this purpose. 
        * 
        * You use a CSIDL in conjunction with one of four Shell functions, SHGetFolderLocation, SHGetFolderPath,
        * SHGetSpecialFolderLocation, and SHGetSpecialFolderPath, to retrieve a special folder's path name or pointer to
        * an item identifier list (PIDL) .
        * 
        * Most CSIDLs correspond to either file system folders or virtual folders. Where the CSIDL identifies a file system folder,
        * a commonly used path is given as an example. Other paths can be used. Some CSIDLs can be mapped to an 
        * equivalent %VariableName% environment variable. CSIDLs are more reliable, however, and should be used if possible. 
        * 
        * Note that some constants represent non-file system elements (e.g. Drives, Nethood) which are part of
        * Windows explorer namespace. These elements do not return file system paths and so may not return a value to the
        * textbox when selected.
        * 
        * 
        * ========================================================================================
        * Constants ==============================================================================
        ...
        * 
        * CSIDL_PERSONAL 
        * File system directory that serves as a common repository for documents. A typical path is
        * C:\Documents and Settings\username\My Documents. This is different from the My Documents virtual
        * folder in the name space. To access  * that virtual folder, use the technique described in Managing the File System. 
        * 
        * CSIDL_FAVORITES 
        * File system directory that serves as a common repository for the user's favourite items.
        * A typical path is C:\Documents and Settings\username\Favorites. 
        *   
        * CSIDL_STARTUP 
        * File system directory that corresponds to the user's Startup program group.
        * The system starts these programs whenever any user logs onto Microsoft® Windows NT® or starts Microsoft® Windows® 98.
        ...
        * A typical path is C:\Documents and Settings\username\Recent. To create a shortcut in this folder, use SHAddToRecentDocs.
        * In addition to creating the shortcut, this function updates the Shell's list of recent documents and adds the
        ...
        *   
        * CSIDL_DIRECTORY 
        * File system directory used to physically store file objects on the desktop (not to be confused with the desktop
        * folder itself). A typical path is C:\Documents and Settings\username\Desktop 
        *   
        * CSIDL_DRIVES 
        * My Computer—virtual folder that contains everything on the local computer: storage devices, printers,
        * and Control Panel. The folder can also contain mapped network drives. 
        *   
        * CSIDL_NETWORK 
        ...
        * It is not the same as CSIDL_NETWORK, which represents the network namespace root. A typical path
        * is C:\Documents and Settings\username\NetHood. 
        *   
        * CSIDL_FONTS 
        ...
        * File system directory that contains the directories for the common program groups that appear in the Start Menu for all users.
        ...
        *   
        * CSIDL_APPDATA 
        * Version 4.71. File system directory that serves as a common repository for application-specific data.
        ...
        *   
        * CSIDL_PRINTHOOD 
        * File system directory that contains the link objects that can exist in the Printers virtual folder.
        * A typical path is C:\Documents and Settings\username\PrintHood. 
        *   
        * CSIDL_LOCAL_APPDATA 
        * Version 5.0. File system directory that serves as a data repository for local (non-roaming) applications.
        ...
        * Version 4.72. File system directory that serves as a common repository for temporary Internet files.
        ...
        * 
        * CSIDL_WINDOWS 
        * Version 5.0. Windows directory or SYSROOT. This corresponds to the %windir% or %SYSTEMROOT% environment variables.
        * A typical path is C:\WINNT. 
        * 
        * CSIDL_SYSTEM 
        ...
        * Typical paths are C:\Documents and Settings\All Users\Documents. Valid for Windows NT systems and Windows 95 and
        ...
        *
        * CSIDL_ADMINTOOLS 
        * Version 5.0. File system directory used to store administrative tools for an individual user.
        * The Microsoft Management Console (MMC) saves customized consoles to this directory, and it roams with the user. 
        *
        * CSIDL_CONNECTIONS 
        ...
        * Typically [User Profile Folder]\Local Settings\Applications Data\Microsoft\CD Burning. 
        *
        * CSIDL_COMPUTERSNEARME 
        * Computers Near Me folder. Virtual folder that contains links to nearby computers on the network.
        * Nearness it is established by common work group membership. 
        *
